...
class Home extends Component {
    ...
    getEvents() {
        fetch(`/events?email=${this.state.email}`)
    ...
    addEvent() {
        ...
        else fetch(`/events/add?name=${name}&category=${category}&place=${place}&address=${address}&startDate=${startDate}&endDate=${endDate}&type=${type}&email=${this.state.email}`)
            .then(this.getEvents)
            .catch(err => console.error(err))
    }

    deleteEvent(e) {
        fetch(`/events/delete?id=${e.target.value}`)
            .then(this.getEvents)
            .catch(err => console.error(err))
    }
